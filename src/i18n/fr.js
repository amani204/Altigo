const fr = {
 ...
 features: {
  ...
  howToOrder: {
    ...
    description: "Pas de compte, pas de complications. Juste trois étapes simples pour recevoir votre pantalon Altigo.",
    step1: { title: "Remplissez le formulaire", desc: "Indiquez votre taille et vos coordonnées" },
    step2: { title: "Confirmation", desc: "Nous vous contactons sur WhatsApp" },
    step3: { title: "Livraison", desc: "Recevez votre commande rapidement" },
  },
  faq: {
    eyebrow: "Aide",
  ...
  region: "Commune / Région",
  regionPlaceholder: "ex: Hydra",
  ...
  errors: {
    ...
    wilaya: "Veuillez renseigner votre wilaya.",
    region: "Veuillez renseigner votre commune.",
  },
},
...
footer: {
  ...
  newsletterText: "Recevez les dernières nouveautés et offres exclusives.",
